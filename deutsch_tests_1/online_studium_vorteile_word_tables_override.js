(function(){
  ...
  function rr(){try{if(window.__finalSchreibenFehlernCleanup)window.__finalSchreibenFehlernCleanup();}catch(e){}try{if(window.__edgeReaderEnhanceLesson)window.__edgeReaderEnhanceLesson();}catch(e){}try{if(window.__selbstoptimierungTitleFix)window.__selbstoptimierungTitleFix();}catch(e){}try{if(window.__selbstoptimierungReaderListFix)window.__selbstoptimierungReaderListFix();}catch(e){}try{if(typeof renderTests==='function'&&window.selectedCategory)renderTests(window.selectedCategory);else if(typeof renderCategoryChoice==='function')renderCategoryChoice();}catch(e){}}
  ...
  function t40(){function o(){add('data_bevor_selbstoptimierung_vorteile_long_override.js?v=1',function(){add('selbstoptimierung_title_fix.js?v=1',function(){add('selbstoptimierung_reader_list_fix.js?v=1',rr)})})}if(window.DEUTSCH_TESTS&&window.DEUTSCH_TESTS.t40){o();return;}add('data_bevor_selbstoptimierung_vorteile.js?v=1',o)}
  ...
  t38();t39();t40();setTimeout(satz2,0);setTimeout(edge,0);setTimeout(clean,20);
  document.addEventListener('DOMContentLoaded',function(){setTimeout(t38,100);setTimeout(t39,130);setTimeout(t40,145);setTimeout(satz2,160);setTimeout(edge,190);setTimeout(clean,240);setTimeout(rr,800);setTimeout(rr,2200);setTimeout(rr,5000);});
  setTimeout(t40,900);setTimeout(clean,1200);setTimeout(rr,6500);
})();
