(function(){
  ...
  function t40(){function o(){add('data_bevor_selbstoptimierung_vorteile_long_override.js?v=1',rr)}if(window.DEUTSCH_TESTS&&window.DEUTSCH_TESTS.t40){o();return;}add('data_bevor_selbstoptimierung_vorteile.js?v=1',o)}
