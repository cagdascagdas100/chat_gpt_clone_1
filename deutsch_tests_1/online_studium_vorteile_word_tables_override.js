(function(){
  ...
  function rr(){try{if(window.__finalSchreibenFehlernCleanup)window.__finalSchreibenFehlernCleanup();}catch(e){}try{if(window.__edgeReaderEnhanceLesson)window.__edgeReaderEnhanceLesson();}catch(e){}try{if(window.__selbstoptimierungTitleFix)window.__selbstoptimierungTitleFix();}catch(e){}try{if(typeof renderTests==='function'&&window.selectedCategory)renderTests(window.selectedCategory);else if(typeof renderCategoryChoice==='function')renderCategoryChoice();}catch(e){}}
  ...
  function t40(){function o(){add('data_bevor_selbstoptimierung_vorteile_long_override.js?v=1',function(){add('selbstoptimierung_title_fix.js?v=1',rr)})}if(window.DEUTSCH_TESTS&&window.DEUTSCH_TESTS.t40){o();return;}add('data_bevor_selbstoptimierung_vorteile.js?v=1',o)}
