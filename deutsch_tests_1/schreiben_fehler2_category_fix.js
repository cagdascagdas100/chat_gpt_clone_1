...
function loadSf2(cb){var n=24;function done(){n--;if(n<=0&&cb)cb();}
...
document.addEventListener('DOMContentLoaded',function(){patchCatOf();loadSf2(function(){window.AAYS_SF2_9_PRELOAD_FORCE_OK=true;});bind();setTimeout(bind,300);setTimeout(bind,1200);});
...
if(document.readyState!=='loading'){patchCatOf();loadSf2(function(){window.AAYS_SF2_9_PRELOAD_FORCE_OK=true;});bind();setTimeout(bind,300);}
})();