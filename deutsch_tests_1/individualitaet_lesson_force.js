(function(){
  ...
  function render(level){
    ...
    if(!lesson){lesson='<h3>Individualität – Nachteile</h3><p>Individualität kann persönliche Freiheit ermöglichen, kann aber problematisch werden, wenn sie zu Egoismus, sozialer Distanz, Leistungsdruck oder Anpassungsproblemen führt.</p>';}
  ...
  function bind(){
    [['btnLessonShort','short'],['btnLessonMedium','medium'],['btnLessonLong','long']].forEach(function(pair){
      ...
      if(!btn||btn.dataset.individualitaetForce==='1')return;
      btn.dataset.individualitaetForce='1';
  ...
  window.forceIndividualitaetLesson=render;
})();
