...
(function(){
  const t=window.DEUTSCH_TESTS.t27;
  const l=window.DEUTSCH_LESSONS.t27;
  if(!t||!l)return;

  const extraWords=[
    'eine finanzielle Mehrbelastung darstellen','die Kostenstruktur eines Betriebs verändern','in besonderem Maße betroffen sein','über geringe Gewinnspannen verfügen','finanzielle Reserven aufbrauchen','den wirtschaftlichen Handlungsspielraum einschränken','auf Neueinstellungen verzichten','Arbeitsstunden reduzieren','die Servicequalität beeinträchtigen','die Vielfalt der lokalen Wirtschaft gefährden','den Berufseinstieg erschweren','niedrigschwellige Einstiegsmöglichkeiten verlieren','eine längere Einarbeitungszeit benötigen','bei der Bewerberauswahl selektiver vorgehen','Produktivitätserwartungen erhöhen','in Konkurrenz zu erfahrenen Bewerbern stehen','höhere Kosten an die Kundschaft weitergeben','den finanziellen Vorteil relativieren','die reale Kaufkraft begrenzen','eine geringere Nachfrage auslösen','das allgemeine Preisniveau beeinflussen','Dokumentationspflichten erfüllen','Arbeitszeiten lückenlos erfassen','Lohnabrechnungen korrekt gestalten','zusätzlichen Verwaltungsaufwand verursachen','betriebliche Abläufe kontrollieren','praktische Umsetzungsprobleme hervorrufen','rechtliche Unsicherheit verursachen','pauschale Aussagen vermeiden','branchenspezifisch argumentieren','langfristige Folgen berücksichtigen','aus wirtschaftlicher Sicht problematisch sein','aus arbeitsmarktpolitischer Perspektive kritisch wirken'
  ];
  t.words=[...(t.words||[]),...extraWords];

  const extraFill=[
    ['Ein höherer Mindestlohn kann die Kostenstruktur eines kleinen Betriebs grundlegend ____.','verändern','Kalıp'],
    ['Gerade arbeitsintensive Branchen können in besonderem Maße ____ sein.','betroffen','Kalıp'],
    ['Kleine Betriebe verfügen oft nicht über genügend Reserven, um Mehrkosten dauerhaft ____.','auszugleichen','Kalıp'],
    ['Dadurch kann ihr wirtschaftlicher Handlungsspielraum erheblich ____ werden.','eingeschränkt','Kalıp'],
    ['Arbeitgeber könnten bei Neueinstellungen selektiver ____.','vorgehen','Kalıp'],
    ['Für Geringqualifizierte kann der Berufseinstieg dadurch zusätzlich ____ werden.','erschwert','Kalıp'],
    ['Steigende Verbraucherpreise können den Lohnvorteil teilweise wieder ____.','relativieren','Kalıp'],
    ['Eine geringere Nachfrage kann wiederum Arbeitsplätze ____.','gefährden','Kalıp'],
    ['Dokumentationspflichten können vor allem kleine Betriebe organisatorisch ____.','belasten','Kalıp'],
    ['Eine differenzierte Argumentation sollte pauschale Aussagen ____.','vermeiden','Stil']
  ];
  t.fill=[...(t.fill||[]),...extraFill];

  const extraPhrase=[
    ['eine finanzielle Mehrbelastung','darstellen'],
    ['die Kostenstruktur','verändern'],
    ['finanzielle Reserven','aufbrauchen'],
    ['den Handlungsspielraum','einschränken'],
    ['auf Neueinstellungen','verzichten'],
    ['Arbeitsstunden','reduzieren'],
    ['die Servicequalität','beeinträchtigen'],
    ['die lokale Wirtschaft','gefährden'],
    ['den Berufseinstieg','erschweren'],
    ['niedrigschwellige Einstiegsmöglichkeiten','verlieren'],
    ['Produktivitätserwartungen','erhöhen'],
    ['Kosten an die Kundschaft','weitergeben'],
    ['den Lohnvorteil','relativieren'],
    ['die reale Kaufkraft','begrenzen'],
    ['eine geringere Nachfrage','auslösen'],
    ['Arbeitszeiten lückenlos','erfassen'],
    ['Lohnabrechnungen korrekt','gestalten'],
    ['zusätzlichen Verwaltungsaufwand','verursachen'],
    ['praktische Umsetzungsprobleme','hervorrufen'],
    ['langfristige Folgen','berücksichtigen']
  ];
  t.phraseMatch=[...(t.phraseMatch||[]),...extraPhrase];

  const extraHang=[
    'eine finanzielle Mehrbelastung darstellen','die Kostenstruktur eines Betriebs verändern','finanzielle Reserven aufbrauchen','den wirtschaftlichen Handlungsspielraum einschränken','auf Neueinstellungen verzichten','Arbeitsstunden reduzieren','die Servicequalität beeinträchtigen','die Vielfalt der lokalen Wirtschaft gefährden','den Berufseinstieg erschweren','niedrigschwellige Einstiegsmöglichkeiten verlieren','bei der Bewerberauswahl selektiver vorgehen','Produktivitätserwartungen erhöhen','Kosten an die Kundschaft weitergeben','den Lohnvorteil relativieren','die reale Kaufkraft begrenzen','eine geringere Nachfrage auslösen','Arbeitszeiten lückenlos erfassen','Lohnabrechnungen korrekt gestalten','zusätzlichen Verwaltungsaufwand verursachen','praktische Umsetzungsprobleme hervorrufen','pauschale Aussagen vermeiden','branchenspezifisch argumentieren','aus arbeitsmarktpolitischer Perspektive kritisch wirken'
  ];
  t.hang=[...(t.hang||[]),...extraHang];

  const patternShort=`<h4>Ek Kalıplar</h4><ul><li>Ein möglicher Nachteil besteht darin, dass ...</li><li>Problematisch ist vor allem, dass ...</li><li>Dies kann dazu führen, dass ...</li><li>Langfristig besteht die Gefahr, dass ...</li></ul>`;

  const patternMedium=`<h4>6. Kalıp Ezberleme ve Örnek Cümleler</h4>
  <p><b>Nachteil einleiten:</b> Ein zentraler Nachteil liegt darin, dass höhere Lohnkosten kleine Betriebe unter Druck setzen können.</p>
  <p><b>Begründung:</b> Dies lässt sich damit begründen, dass kleine Unternehmen häufig nur über geringe Gewinnspannen verfügen.</p>
  <p><b>Folge:</b> Infolgedessen könnten sie Preise anheben, Arbeitszeiten reduzieren oder auf Neueinstellungen verzichten.</p>
  <p><b>Differenzierung:</b> Besonders relevant ist dieses Argument in arbeitsintensiven Branchen wie Gastronomie, Reinigung, Einzelhandel oder Friseurhandwerk.</p>
  <p><b>Bewertung:</b> Langfristig betrachtet kann dies die Wettbewerbsfähigkeit kleiner Betriebe schwächen.</p>`;

  const patternLong=`<h4>8. C1/C2-Kalıp Bankası: Nachteil Einleiten</h4>
<ul>
...
<li>Diese Entwicklung sollte jedoch differenziert betrachtet werden, weil ...</li>
  ...
  l.short=(l.short||'')+patternShort;
  l.medium=(l.medium||'')+patternMedium;
  l.long=(l.long||'')+patternLong;
})();
