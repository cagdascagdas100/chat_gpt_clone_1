...
status=SINGLE_PASS_RUNNER_SMOKE_PROOF_VERIFIED_QUEUE_METADATA_PENDING
last_updated=2026-07-04T01:52:00+03:00
...
- Single shared runner smoke proof is now readable on GitHub.
...
- The queue JSON itself still says `status=pending`, so queue metadata cleanup remains open.
