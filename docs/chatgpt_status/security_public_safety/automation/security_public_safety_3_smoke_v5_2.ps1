...
if (-not (Test-Path -LiteralPath $pythonScript -PathType Leaf)) {
  throw "V5_2_2_SMOKE_PYTHON_SCRIPT_MISSING: $pythonScript"
}
...
Write-Output 'TASK_VERSION=5.2.2-strict-payload-and-field-gates'
Write-Output 'ATTEMPT_ID=security-public-safety-3-20260721-011'
