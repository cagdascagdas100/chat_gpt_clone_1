...
$pageKey = 'aays1'
$taskId = 'aays1-ready-to-sell-bulk-photo-polygon-evidence-40-20260711'
...
$evidenceRootRelative = 'england_map_web/data/geometry_review_3of4/vision_evidence/153_bulk_evidence_40_20260711'
$statusRelative = 'docs/chatgpt_status/aays1/status/153_aays1_bulk_photo_polygon_evidence_40_latest.json'
$reportRelative = 'docs/chatgpt_status/aays1/reports/153_aays1_bulk_photo_polygon_evidence_40_report.md'
...
$lines.Add('# ReadyToSell Bulk Photo and Polygon Evidence - 40 Rows')
$lines.Add('')
