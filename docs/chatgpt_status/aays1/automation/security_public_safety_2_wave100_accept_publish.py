...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave100")
text = text.replace("wave32", "wave100")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "24160")
text = text.replace("__WAVE71_QUEUE__", "0075_security_public_safety_2_priority_24160row_incremental_evidence_expansion_20260731.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "10ea08a63cadb3f21d8612f3566dbc0d6e13164329aeb2a8731ad37af7b3be0b")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 54922)"),
    ("parcel_31351", "parcel_54921"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 22952"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 1.86'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 23710'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_24160row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_24160row_incremental_evidence_expansion_20260731"),
    ("priority_24160row_browser_acceptance_wave100_receipt_20260729.json", "priority_24160row_browser_acceptance_wave100_receipt_20260731.json"),
    ("priority_24160row_targeted_retry_wave100_diagnostic_20260729.json", "priority_24160row_targeted_retry_wave100_diagnostic_20260731.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'24160 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'24160 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 24160 and time.time() < dom_deadline:
