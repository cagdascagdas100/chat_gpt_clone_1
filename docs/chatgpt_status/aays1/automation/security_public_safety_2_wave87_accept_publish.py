...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave87")
text = text.replace("wave32", "wave87")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "18310")
text = text.replace("__WAVE71_QUEUE__", "0062_security_public_safety_2_priority_18310row_incremental_evidence_expansion_20260730.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "aa12cea3d7564174185e8affd22340d50552b8abf49e22bf9608a55f8656bf11")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 49072)"),
    ("parcel_31351", "parcel_49071"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 17395"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 2.46'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 17860'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_18310row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_18310row_incremental_evidence_expansion_20260730"),
    ("priority_18310row_browser_acceptance_wave87_receipt_20260729.json", "priority_18310row_browser_acceptance_wave87_receipt_20260730.json"),
    ("priority_18310row_targeted_retry_wave87_diagnostic_20260729.json", "priority_18310row_targeted_retry_wave87_diagnostic_20260730.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'18310 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'18310 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 18310 and time.time() < dom_deadline:
