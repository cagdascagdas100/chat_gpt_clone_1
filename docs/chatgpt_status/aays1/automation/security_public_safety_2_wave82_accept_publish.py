...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave82")
text = text.replace("wave32", "wave82")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "16060")
text = text.replace("__WAVE71_QUEUE__", "0057_security_public_safety_2_priority_16060row_incremental_evidence_expansion_20260730.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "d8a5ce52bb046348859f324e448bd9caefd43b5386dbb576bd8767c9305a0d0e")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 46822)"),
    ("parcel_31351", "parcel_46821"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 15257"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 2.80'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 15610'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_16060row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_16060row_incremental_evidence_expansion_20260730"),
    ("priority_16060row_browser_acceptance_wave82_receipt_20260729.json", "priority_16060row_browser_acceptance_wave82_receipt_20260730.json"),
    ("priority_16060row_targeted_retry_wave82_diagnostic_20260729.json", "priority_16060row_targeted_retry_wave82_diagnostic_20260730.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'16060 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'16060 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 16060 and time.time() < dom_deadline:
