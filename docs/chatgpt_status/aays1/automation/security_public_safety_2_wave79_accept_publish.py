...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave79")
text = text.replace("wave32", "wave79")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "14710")
text = text.replace("__WAVE71_QUEUE__", "0054_security_public_safety_2_priority_14710row_incremental_evidence_expansion_20260730.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "38fc96b4516cf859c4b72a016e8c2b52f9cbb33d219c3fdadf8af1d011b4e484")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 45472)"),
    ("parcel_31351", "parcel_45471"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 13975"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 3.06'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 14260'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_14710row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_14710row_incremental_evidence_expansion_20260730"),
    ("priority_14710row_browser_acceptance_wave79_receipt_20260729.json", "priority_14710row_browser_acceptance_wave79_receipt_20260730.json"),
    ("priority_14710row_targeted_retry_wave79_diagnostic_20260729.json", "priority_14710row_targeted_retry_wave79_diagnostic_20260730.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'14710 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'14710 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 14710 and time.time() < dom_deadline:
