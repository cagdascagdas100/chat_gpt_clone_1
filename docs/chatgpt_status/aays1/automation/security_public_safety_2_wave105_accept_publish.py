...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave105")
text = text.replace("wave32", "wave105")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "26410")
text = text.replace("__WAVE71_QUEUE__", "0080_security_public_safety_2_priority_26410row_incremental_evidence_expansion_20260731.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "c88ff5cd9693d956af9df90a59b630a07a954b5d504de33d6f0a71bb097cf57d")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 57172)"),
    ("parcel_31351", "parcel_57171"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 25090"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 1.70'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 25960'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_26410row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_26410row_incremental_evidence_expansion_20260731"),
    ("priority_26410row_browser_acceptance_wave105_receipt_20260729.json", "priority_26410row_browser_acceptance_wave105_receipt_20260731.json"),
    ("priority_26410row_targeted_retry_wave105_diagnostic_20260729.json", "priority_26410row_targeted_retry_wave105_diagnostic_20260731.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'26410 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'26410 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 26410 and time.time() < dom_deadline:
