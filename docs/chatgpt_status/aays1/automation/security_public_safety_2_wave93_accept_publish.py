...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave93")
text = text.replace("wave32", "wave93")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "21010")
text = text.replace("__WAVE71_QUEUE__", "0068_security_public_safety_2_priority_21010row_incremental_evidence_expansion_20260730.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "aedff5e02bd2ea03fde7b7a30bdca3f447d5f087f7c9ef726de4a6b11ca9a136")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 51772)"),
    ("parcel_31351", "parcel_51771"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 19960"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 2.14'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 20560'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_21010row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_21010row_incremental_evidence_expansion_20260730"),
    ("priority_21010row_browser_acceptance_wave93_receipt_20260729.json", "priority_21010row_browser_acceptance_wave93_receipt_20260730.json"),
    ("priority_21010row_targeted_retry_wave93_diagnostic_20260729.json", "priority_21010row_targeted_retry_wave93_diagnostic_20260730.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'21010 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'21010 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 21010 and time.time() < dom_deadline:
