...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave81")
text = text.replace("wave32", "wave81")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "15610")
text = text.replace("__WAVE71_QUEUE__", "0056_security_public_safety_2_priority_15610row_incremental_evidence_expansion_20260730.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "27ad2fbd199403398e4154a154394cd37034cbf17ce7f020c3b724c02b508616")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 46372)"),
    ("parcel_31351", "parcel_46371"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 14830"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 2.88'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 15160'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_15610row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_15610row_incremental_evidence_expansion_20260730"),
    ("priority_15610row_browser_acceptance_wave81_receipt_20260729.json", "priority_15610row_browser_acceptance_wave81_receipt_20260730.json"),
    ("priority_15610row_targeted_retry_wave81_diagnostic_20260729.json", "priority_15610row_targeted_retry_wave81_diagnostic_20260730.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'15610 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'15610 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 15610 and time.time() < dom_deadline:
