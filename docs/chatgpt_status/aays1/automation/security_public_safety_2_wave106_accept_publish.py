...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave106")
text = text.replace("wave32", "wave106")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "26860")
text = text.replace("__WAVE71_QUEUE__", "0081_security_public_safety_2_priority_26860row_incremental_evidence_expansion_20260731.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "64b0a7adc96e0f7d6f5945b9be115448bf3242d197f70ba0de9c736fac53e96e")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 57622)"),
    ("parcel_31351", "parcel_57621"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 25517"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 1.68'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 26410'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_26860row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_26860row_incremental_evidence_expansion_20260731"),
    ("priority_26860row_browser_acceptance_wave106_receipt_20260729.json", "priority_26860row_browser_acceptance_wave106_receipt_20260731.json"),
    ("priority_26860row_targeted_retry_wave106_diagnostic_20260729.json", "priority_26860row_targeted_retry_wave106_diagnostic_20260731.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'26860 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'26860 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 26860 and time.time() < dom_deadline:
