...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave86")
text = text.replace("wave32", "wave86")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "17860")
text = text.replace("__WAVE71_QUEUE__", "0061_security_public_safety_2_priority_17860row_incremental_evidence_expansion_20260730.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "8e1e55ab6a4812d1147e314a07cdf19277c46a84a4b553e205c79b50dade1da7")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 48622)"),
    ("parcel_31351", "parcel_48621"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 16967"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 2.52'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 17410'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_17860row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_17860row_incremental_evidence_expansion_20260730"),
    ("priority_17860row_browser_acceptance_wave86_receipt_20260729.json", "priority_17860row_browser_acceptance_wave86_receipt_20260730.json"),
    ("priority_17860row_targeted_retry_wave86_diagnostic_20260729.json", "priority_17860row_targeted_retry_wave86_diagnostic_20260730.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'17860 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'17860 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 17860 and time.time() < dom_deadline:
