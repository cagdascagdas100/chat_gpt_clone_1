...
blob SHA-1 separately from the 64-character raw file SHA-256. It extracts exact
rows 20-24, runs official geometry with the slot-local HMLR resolver, then
