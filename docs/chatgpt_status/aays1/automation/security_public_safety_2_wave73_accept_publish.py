...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave73")
text = text.replace("wave32", "wave73")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "12010")
text = text.replace("__WAVE71_QUEUE__", "0048_security_public_safety_2_priority_12010row_incremental_evidence_expansion_20260730.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "8677308be6b7c286d15f61c097739a919387cc3219fba2649b2ffc250a319603")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 42772)"),
    ("parcel_31351", "parcel_42771"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 11410"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 3.75'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 11560'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_12010row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_12010row_incremental_evidence_expansion_20260730"),
    ("priority_12010row_browser_acceptance_wave73_receipt_20260729.json", "priority_12010row_browser_acceptance_wave73_receipt_20260730.json"),
    ("priority_12010row_targeted_retry_wave73_diagnostic_20260729.json", "priority_12010row_targeted_retry_wave73_diagnostic_20260730.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'12010 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'12010 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 12010 and time.time() < dom_deadline:
