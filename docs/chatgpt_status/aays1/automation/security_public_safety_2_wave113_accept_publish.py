...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave113")
text = text.replace("wave32", "wave113")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "30010")
text = text.replace("__WAVE71_QUEUE__", "0088_security_public_safety_2_priority_30010row_incremental_evidence_expansion_20260731.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "56d98350cafe88a2f19a896be15a0bf30c76ec772f992d43cb30b2ca9e905189")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 60772)"),
    ("parcel_31351", "parcel_60771"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 28510"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 1.50'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 29560'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_30010row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_30010row_incremental_evidence_expansion_20260731"),
    ("priority_30010row_browser_acceptance_wave113_receipt_20260729.json", "priority_30010row_browser_acceptance_wave113_receipt_20260731.json"),
    ("priority_30010row_targeted_retry_wave113_diagnostic_20260729.json", "priority_30010row_targeted_retry_wave113_diagnostic_20260731.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'30010 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'30010 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 30010 and time.time() < dom_deadline:
