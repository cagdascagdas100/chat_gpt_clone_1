...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave76")
text = text.replace("wave32", "wave76")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "13360")
text = text.replace("__WAVE71_QUEUE__", "0051_security_public_safety_2_priority_13360row_incremental_evidence_expansion_20260730.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "8ffc9b537d79f7ae2f8c1c60b6945e2b8cbe9d92cf531d3e5c5527d8f4b4960e")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 44122)"),
    ("parcel_31351", "parcel_44121"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 12692"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 3.37'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 12910'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_13360row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_13360row_incremental_evidence_expansion_20260730"),
    ("priority_13360row_browser_acceptance_wave76_receipt_20260729.json", "priority_13360row_browser_acceptance_wave76_receipt_20260730.json"),
    ("priority_13360row_targeted_retry_wave76_diagnostic_20260729.json", "priority_13360row_targeted_retry_wave76_diagnostic_20260730.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'13360 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'13360 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 13360 and time.time() < dom_deadline:
