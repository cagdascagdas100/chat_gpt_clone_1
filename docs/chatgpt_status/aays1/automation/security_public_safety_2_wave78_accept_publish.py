...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave78")
text = text.replace("wave32", "wave78")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "14260")
text = text.replace("__WAVE71_QUEUE__", "0053_security_public_safety_2_priority_14260row_incremental_evidence_expansion_20260730.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "2cc8451e9fc6c56c340af6d0f8126f07fe327a0411de024472f8c3250a1f765d")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 45022)"),
    ("parcel_31351", "parcel_45021"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 13547"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 3.16'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 13810'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_14260row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_14260row_incremental_evidence_expansion_20260730"),
    ("priority_14260row_browser_acceptance_wave78_receipt_20260729.json", "priority_14260row_browser_acceptance_wave78_receipt_20260730.json"),
    ("priority_14260row_targeted_retry_wave78_diagnostic_20260729.json", "priority_14260row_targeted_retry_wave78_diagnostic_20260730.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'14260 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'14260 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 14260 and time.time() < dom_deadline:
