...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave80")
text = text.replace("wave32", "wave80")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "15160")
text = text.replace("__WAVE71_QUEUE__", "0055_security_public_safety_2_priority_15160row_incremental_evidence_expansion_20260730.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "c2bff1ff33ef162e11fadf8e0e02284953f44d88feb0f6291018fcc9c966b50c")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 45922)"),
    ("parcel_31351", "parcel_45921"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 14402"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 2.97'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 14710'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_15160row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_15160row_incremental_evidence_expansion_20260730"),
    ("priority_15160row_browser_acceptance_wave80_receipt_20260729.json", "priority_15160row_browser_acceptance_wave80_receipt_20260730.json"),
    ("priority_15160row_targeted_retry_wave80_diagnostic_20260729.json", "priority_15160row_targeted_retry_wave80_diagnostic_20260730.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'15160 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'15160 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 15160 and time.time() < dom_deadline:
