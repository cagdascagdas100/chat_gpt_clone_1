...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave88")
text = text.replace("wave32", "wave88")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "18760")
text = text.replace("__WAVE71_QUEUE__", "0063_security_public_safety_2_priority_18760row_incremental_evidence_expansion_20260730.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "cc4820ece5096f0f936f662886e0fb2ebf766fd5da822eab9b472eb111967a14")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 49522)"),
    ("parcel_31351", "parcel_49521"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 17822"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 2.40'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 18310'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_18760row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_18760row_incremental_evidence_expansion_20260730"),
    ("priority_18760row_browser_acceptance_wave88_receipt_20260729.json", "priority_18760row_browser_acceptance_wave88_receipt_20260730.json"),
    ("priority_18760row_targeted_retry_wave88_diagnostic_20260729.json", "priority_18760row_targeted_retry_wave88_diagnostic_20260730.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'18760 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'18760 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 18760 and time.time() < dom_deadline:
