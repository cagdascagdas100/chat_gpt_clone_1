...
direct = [
    (r'''('\"schema_version\": 69', '\"schema_version\": 70'),''', r'''('\"schema_version\": 72', '\"schema_version\": 73'),'''),
    ('"schema_version": 115,', '"schema_version": 118,'),
    ('"schema_version": 119,', '"schema_version": 122,'),
    ('"schema_version": 114,', '"schema_version": 117,'),
    ('or 141) + 1', 'or 144) + 1'),
    ('"priority": -168,', '"priority": -171,'),
    ('97.81', '97.95'),
    ('WAVE92', 'WAVE95'),
]
...
resolved = [
    ("__SOURCE_HEAD__", "dabbd0033f975ec090d08f7559018ca2d3b127a9"),
    ("__PREVIOUS_CONTINUATION__", "09d58c6ca20d0d23243de6995f6f210244bc792c2351da58e465f45c69939ef7"),
    ("__CURRENT_CONTINUATION__", "6bc431af6cc4906e7a15cf6d7e0254586750c82f63a73123b1505b77a69c29ea"),
    ("__PREVIOUS_WAVE__", "wave94"),
    ("__CURRENT_WAVE__", "wave95"),
    ("__PREVIOUS_QUEUE__", "0069_"),
    ("__CURRENT_QUEUE__", "0070_"),
    ("__ROWS_OLD_PREVIOUS__", "21010"),
    ("__ROWS_BASE__", "21460"),
    ("__ROWS_TARGET__", "21910"),
    ("__MIN_OLD_PREVIOUS__", "20387"),
    ("__MIN_CURRENT__", "20815"),
    ("__ACCURACY_BASE__", "21194"),
    ("__PARCEL_OLD_START__", "51772"),
    ("__PARCEL_START__", "52222"),
    ("__PARCEL_END_PLUS_ONE__", "52672"),
    ("__PARCEL_OLD_END__", "52221"),
    ("__PARCEL_END__", "52671"),
    ("__DELTA_PREVIOUS__", "2.10"),
    ("__DELTA_CURRENT__", "2.05"),
]
...
wrapper_old_target = "security_public_safety_2_priority_21910row_incremental_evidence_expansion_20260730"
wrapper_new_target = "security_public_safety_2_priority_21910row_incremental_evidence_expansion_20260731"
...
new_target_task = "security_public_safety_2_priority_21910row_incremental_evidence_expansion_20260731"
...
acceptance_patch = chr(10).join([
    ...
    '    old_acceptance_task = "security_public_safety_2_priority_21910row_incremental_evidence_expansion_20260730"',
    '    new_acceptance_task = "security_public_safety_2_priority_21910row_incremental_evidence_expansion_20260731"',
    ...
    '    acc = acc.replace("priority_21910row_browser_acceptance_wave95_receipt_20260730", "priority_21910row_browser_acceptance_wave95_receipt_20260731")',
    '    acc = acc.replace("priority_21910row_targeted_retry_wave95_diagnostic_20260730", "priority_21910row_targeted_retry_wave95_diagnostic_20260731")',
    '    for fragment in (',
])
...
required = [
    'SOURCE_HEAD = "dabbd0033f975ec090d08f7559018ca2d3b127a9"',
    'FIRST_STEP = "EXPAND_CANONICAL_BROWSER_VISIBLE_SAMPLE_FROM_21460_TO_21910_ROWS_WITH_OFFICIAL_SOURCE_HASHES"',
    'CONTINUATION_KEY = "6bc431af6cc4906e7a15cf6d7e0254586750c82f63a73123b1505b77a69c29ea"',
    'TASK_ID = "security_public_safety_2_priority_21910row_incremental_evidence_expansion_20260731"',
    'OWNER = "github-actions-security-public-safety-2-wave95"',
    '0070_security_public_safety_2_priority_21910row_incremental_evidence_expansion_20260731.v3.task.json',
    'priority_450row_wave95_latest.json',
    'priority_21910row_evidence_expansion_latest.json',
    '"accepted_base_rows": 21460',
    '"merged_candidate_rows": 21910',
    '"minimum_merged_police_hash_rows": 20815',
    '"incremental_parcel_start": 52222',
    '"incremental_parcel_end": 52671',
    '"expanded_scope_progress_percent": 97.95',
    '"expanded_scope_delta_percentage_points": 2.05',
    'len(rows) != 21910',
    '"parcel_52671"',
    'WAVE95_REMOTE_TERMINAL_READBACK_FAILED',
]
