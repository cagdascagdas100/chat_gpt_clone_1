...
def fetch_json(url: str) -> dict[str, Any]:
    request = urllib.request.Request(
        url,
        headers={
            "User-Agent": "AAYS-security-metropolitan-scope/2.0",
...
def main() -> int:
    ...
    v3.CANDIDATE_LIMIT = CANDIDATE_LIMIT
    v3.EXPECTED_UNIQUE_ENDPOINTS = EXPECTED_UNIQUE_ENDPOINTS
        ...
        acceptance.update(
            {
                ...
                "status": "BLOCKED",
                "metropolitan_force_scope": force_report,
            }
        )
