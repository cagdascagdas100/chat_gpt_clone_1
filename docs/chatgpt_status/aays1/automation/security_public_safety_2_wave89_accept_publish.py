...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave89")
text = text.replace("wave32", "wave89")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "19210")
text = text.replace("__WAVE71_QUEUE__", "0064_security_public_safety_2_priority_19210row_incremental_evidence_expansion_20260730.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "21fae46679279c6057c40339323cc9366d53ea78ea9367d64c8b748798a8ac2a")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 49972)"),
    ("parcel_31351", "parcel_49971"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 18250"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 2.34'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 18760'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_19210row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_19210row_incremental_evidence_expansion_20260730"),
    ("priority_19210row_browser_acceptance_wave89_receipt_20260729.json", "priority_19210row_browser_acceptance_wave89_receipt_20260730.json"),
    ("priority_19210row_targeted_retry_wave89_diagnostic_20260729.json", "priority_19210row_targeted_retry_wave89_diagnostic_20260730.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'19210 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'19210 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 19210 and time.time() < dom_deadline:
