...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave94")
text = text.replace("wave32", "wave94")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "21460")
text = text.replace("__WAVE71_QUEUE__", "0069_security_public_safety_2_priority_21460row_incremental_evidence_expansion_20260731.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "09d58c6ca20d0d23243de6995f6f210244bc792c2351da58e465f45c69939ef7")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 52222)"),
    ("parcel_31351", "parcel_52221"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 20387"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 2.10'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 21010'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_21460row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_21460row_incremental_evidence_expansion_20260731"),
    ("priority_21460row_browser_acceptance_wave94_receipt_20260729.json", "priority_21460row_browser_acceptance_wave94_receipt_20260731.json"),
    ("priority_21460row_targeted_retry_wave94_diagnostic_20260729.json", "priority_21460row_targeted_retry_wave94_diagnostic_20260731.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'21460 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'21460 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 21460 and time.time() < dom_deadline:
