...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave96")
text = text.replace("wave32", "wave96")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "22360")
text = text.replace("__WAVE71_QUEUE__", "0071_security_public_safety_2_priority_22360row_incremental_evidence_expansion_20260731.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "1486d431576a8dcdd404cf0e8630338af66e73694ce8f9be71a6936afa272732")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 53122)"),
    ("parcel_31351", "parcel_53121"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 21242"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 2.01'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 21910'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_22360row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_22360row_incremental_evidence_expansion_20260731"),
    ("priority_22360row_browser_acceptance_wave96_receipt_20260729.json", "priority_22360row_browser_acceptance_wave96_receipt_20260731.json"),
    ("priority_22360row_targeted_retry_wave96_diagnostic_20260729.json", "priority_22360row_targeted_retry_wave96_diagnostic_20260731.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'22360 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'22360 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 22360 and time.time() < dom_deadline:
