...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave103")
text = text.replace("wave32", "wave103")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "25510")
text = text.replace("__WAVE71_QUEUE__", "0078_security_public_safety_2_priority_25510row_incremental_evidence_expansion_20260731.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "bbf5266a5005f0dd7b09e450bf9f96af840df7acf2a123d2e42652451f619568")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 56272)"),
    ("parcel_31351", "parcel_56271"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 24235"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 1.76'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 25060'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_25510row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_25510row_incremental_evidence_expansion_20260731"),
    ("priority_25510row_browser_acceptance_wave103_receipt_20260729.json", "priority_25510row_browser_acceptance_wave103_receipt_20260731.json"),
    ("priority_25510row_targeted_retry_wave103_diagnostic_20260729.json", "priority_25510row_targeted_retry_wave103_diagnostic_20260731.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'25510 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'25510 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 25510 and time.time() < dom_deadline:
