...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave83")
text = text.replace("wave32", "wave83")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "16510")
text = text.replace("__WAVE71_QUEUE__", "0058_security_public_safety_2_priority_16510row_incremental_evidence_expansion_20260730.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "421da5bbd1900635468d505157e7d5d90dde2d4644915102b0db9b4898c5d1e6")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 47272)"),
    ("parcel_31351", "parcel_47271"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 15685"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 2.73'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 16060'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_16510row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_16510row_incremental_evidence_expansion_20260730"),
    ("priority_16510row_browser_acceptance_wave83_receipt_20260729.json", "priority_16510row_browser_acceptance_wave83_receipt_20260730.json"),
    ("priority_16510row_targeted_retry_wave83_diagnostic_20260729.json", "priority_16510row_targeted_retry_wave83_diagnostic_20260730.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'16510 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'16510 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 16510 and time.time() < dom_deadline:
