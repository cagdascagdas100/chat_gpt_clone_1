...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave74")
text = text.replace("wave32", "wave74")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "12460")
text = text.replace("__WAVE71_QUEUE__", "0049_security_public_safety_2_priority_12460row_incremental_evidence_expansion_20260730.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "da250374a0da5cccb66c7753f87ba749f5e282ede5bb497ea9f4496d2081b460")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 43222)"),
    ("parcel_31351", "parcel_43221"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 11838"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 3.61'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 12010'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_12460row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_12460row_incremental_evidence_expansion_20260730"),
    ("priority_12460row_browser_acceptance_wave74_receipt_20260729.json", "priority_12460row_browser_acceptance_wave74_receipt_20260730.json"),
    ("priority_12460row_targeted_retry_wave74_diagnostic_20260729.json", "priority_12460row_targeted_retry_wave74_diagnostic_20260730.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'12460 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'12460 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 12460 and time.time() < dom_deadline:
