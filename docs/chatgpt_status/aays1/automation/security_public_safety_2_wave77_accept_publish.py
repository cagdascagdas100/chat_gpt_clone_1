...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave77")
text = text.replace("wave32", "wave77")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "13810")
text = text.replace("__WAVE71_QUEUE__", "0052_security_public_safety_2_priority_13810row_incremental_evidence_expansion_20260730.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "a005e9d21cc290b1e472eed6081436250a1cb344df18bc87aa7a25b2eb09db2d")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 44572)"),
    ("parcel_31351", "parcel_44571"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 13120"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 3.26'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 13360'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_13810row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_13810row_incremental_evidence_expansion_20260730"),
    ("priority_13810row_browser_acceptance_wave77_receipt_20260729.json", "priority_13810row_browser_acceptance_wave77_receipt_20260730.json"),
    ("priority_13810row_targeted_retry_wave77_diagnostic_20260729.json", "priority_13810row_targeted_retry_wave77_diagnostic_20260730.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'13810 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'13810 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 13810 and time.time() < dom_deadline:
...
required = [
    'CONTINUATION_KEY = "a005e9d21cc290b1e472eed6081436250a1cb344df18bc87aa7a25b2eb09db2d"',
