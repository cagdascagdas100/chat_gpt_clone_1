...
$WorkerPath = Join-Path $RepoRoot 'docs\chatgpt_status\aays1\automation\ready_to_sell_1_automation_167_dom_proof_v12.py'
...
try {
    ...
    if ($LASTEXITCODE -ne 0) {
        throw "READY_TO_SELL_1_AUTOMATION_167_V12_FAILED_EXIT_$LASTEXITCODE"
    }
}
finally {
    Pop-Location
