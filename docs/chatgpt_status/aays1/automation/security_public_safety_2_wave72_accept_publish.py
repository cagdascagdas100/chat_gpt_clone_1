...
text = text.replace(old_owner, "github-actions-security-public-safety-2-wave72")
text = text.replace("wave32", "wave72")
if "590" not in text:
    raise SystemExit("EXPECTED_590_TARGET_FRAGMENTS_MISSING")
text = text.replace("590", "11560")
text = text.replace("__WAVE71_QUEUE__", "0047_security_public_safety_2_priority_11560row_incremental_evidence_expansion_20260730.v3.task.json")
text = text.replace("__WAVE71_CONTINUATION__", "e80c765946c15e4233d5137b2c44bfde0c56ec923f52eb105038fb4d9369b2b5")

required_replacements = [
    ("range(30762, 31352)", "range(30762, 42322)"),
    ("parcel_31351", "parcel_42321"),
    ("MIN_QUALITY = 561", "MIN_QUALITY = 10982"),
    ('"progress_delta_percentage_points": 11.86', '"progress_delta_percentage_points": 3.89'),
    ('"accepted_base_candidate_rows": 520', '"accepted_base_candidate_rows": 11110'),
    ('"incremental_rows_target": 70', '"incremental_rows_target": 450'),
    ('"incremental_rows_completed": 70', '"incremental_rows_completed": 450'),
    ("security_public_safety_2_priority_11560row_incremental_evidence_expansion_20260729", "security_public_safety_2_priority_11560row_incremental_evidence_expansion_20260730"),
    ("priority_11560row_browser_acceptance_wave72_receipt_20260729.json", "priority_11560row_browser_acceptance_wave72_receipt_20260730.json"),
    ("priority_11560row_targeted_retry_wave72_diagnostic_20260729.json", "priority_11560row_targeted_retry_wave72_diagnostic_20260730.json"),
]
...
old_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'11560 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()"""
new_dom = """            locator = page.locator("xpath=//h2[contains(normalize-space(.),'11560 örnek satır')]/following-sibling::table[1]/tbody/tr")
            dom_rows = locator.count()
            dom_deadline = time.time() + 180
            while dom_rows < 11560 and time.time() < dom_deadline:
