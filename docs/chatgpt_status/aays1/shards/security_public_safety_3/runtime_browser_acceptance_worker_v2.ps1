...
# Run the inner worker in a child PowerShell process. The inner script uses exit 0/1;
# process isolation ensures those exits cannot terminate this wrapper before the
# rendered-table contract is evaluated and persisted.
