...
def main():
    ...
    bad_relation = copy.deepcopy(base); bad_relation["relation_pair_contract_validation"]["pair_rows_validated"] = 14
    fixtures.append(("relation_pair_incomplete", bad_relation, "FAIL"))
