...
$innerBlob = '35c561fcb21aa7ac87ee27bef41636c773f9cdc9'
...
$ownershipText=(& $git.Source -C $repoRoot show "origin/${branch}:$ownershipRel" 2>&1|Out-String)
