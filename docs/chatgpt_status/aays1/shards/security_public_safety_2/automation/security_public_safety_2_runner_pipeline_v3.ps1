...
$Script = Join-Path $RepoRoot 'docs\chatgpt_status\aays1\shards\security_public_safety_2\automation\security_public_safety_2_runner_pipeline_v3_sources.py'
if (-not (Test-Path -LiteralPath $Script)) { Write-Error "MISSING_SOURCE_AWARE_PIPELINE:$Script"; exit 3 }
