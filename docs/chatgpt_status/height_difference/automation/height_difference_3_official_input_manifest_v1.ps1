...
param(
  ...
  [string]$Report='docs/chatgpt_status/height_difference/runner_outputs/height_difference_3_official_input_manifest_latest.json',
  [string]$WebsiteReport='england_map_web/data/height_difference/height_difference_3_official_input_manifest_latest.json',
...
$args=@(
  ...
  '--website-report',(& $resolve $WebsiteReport),
  '--work-dir',(& $resolve $WorkDir),
  '--hmlr-release-date','2026-07-05',
