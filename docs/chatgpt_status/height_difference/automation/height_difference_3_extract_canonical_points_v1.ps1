...
$scriptRelative = 'docs/chatgpt_status/height_difference/automation/height_difference_3_extract_canonical_points_v1.py'
...
try {
    ...
    Write-Host "HEIGHT_DIFFERENCE_3_EXTRACTOR_EXIT_CODE=$exitCode"
