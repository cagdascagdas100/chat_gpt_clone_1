...
checks={
  ...
  "ten_examples":len(examples.get("examples",[]))==10,
  ...
  "resolution_examples_and_rejects":resolution_ids=={7,8,9,10} and sum(x["decision"]=="REJECT_FAIL_CLOSED" for x in examples["examples"])==3,
  "validation_314":contract["combined_validation"]=={"passed":314,"total":314},
  "candidate_tests_25":contract["candidate_integrity_selftest"]=={"passed":25,"total":25},
  "resolution_tests_18":contract["postcode_resolution_selftest"]=={"passed":18,"total":18},
  "consistency_tests_14":contract["review_contract_consistency_selftest"]=={"passed":14,"total":14},
  "wrapper_tests_40":contract["run_and_audit_wrapper_contract"]=={"passed":40,"total":40},
  ...
  "operation_range_135":sorted(by_id)==list(range(1,136)),
  "single_current_blocker":len(blocked)==1 and blocked[0]["id"]==135,
