...
checks = {
    ...
    "diagnostics_schema_v4": "schema_version = 4" in script,
    ...
    "v2_validator_selftest": "014_selftest_validate_ofcom_v2_corrections.py" in script and "Run-JsonSelftest $v2ValidatorSelftest 32" in script,
