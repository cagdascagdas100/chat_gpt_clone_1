...
checks = {
    ...
    "extended_provenance_selftest_20": 'Run-JsonSelftest $extendedProvenanceSelftest 20' in script,
    "extended_provenance_status": "PASS_EXTENDED_SINGLE_RUN_PROVENANCE_CHAIN_AUDITED_REVIEW_ONLY" in script,
    "provenance_artifact_16": "provenance_artifact_count -ne 16" in script,
    ...
    "consistency_selftest_14": 'Run-JsonSelftest $consistencyVerifierSelftest 14' in script,
    ...
    "combined_validation_404": "$expectedCombinedValidation = 404" in script and "combined_validation_total" in script,
    ...
    "schema_v7": "schema_version = 7" in script,
}
