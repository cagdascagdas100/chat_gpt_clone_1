#!/usr/bin/env python3
"""Classifier V5: bind classification to the exact Parser V17 aliases.
...
import HYDRATE_TARGET_PARSE_PRTR_PI_HMLR_20260722_V17 as parser_v17

classifier.TARGETS = tuple(dict.fromkeys(parser_v17.base.TARGET_TOKENS))
