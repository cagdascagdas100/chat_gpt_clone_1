#!/usr/bin/env python3
"""Classifier V4: bind classification to the exact Parser V16 aliases.
...
import HYDRATE_TARGET_PARSE_PRTR_PI_HMLR_20260722_V16 as parser_v16

classifier.TARGETS = tuple(dict.fromkeys(parser_v16.base.TARGET_TOKENS))
