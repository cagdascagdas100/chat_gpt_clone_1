# Parcel Label - 15 Slot Gecis Raporu

- Mevcut ChatGPT sayfasi SLOT_ID=parcel_label_1 olarak devam eder.
- Yeni ikinci sayfa SLOT_ID=parcel_label_2 kullanir.
- Yeni ucuncu sayfa SLOT_ID=parcel_label_3 kullanir.
