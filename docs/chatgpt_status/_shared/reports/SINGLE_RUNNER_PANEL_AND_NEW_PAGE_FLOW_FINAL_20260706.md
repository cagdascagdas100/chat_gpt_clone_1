...
AAYS / TerraYield devam. Repo cagdascagdas100/chat_gpt_clone_1 branch codex/aays-single-runner-v5-20260706. Tek shared runner kullan; yeni runner aÃƒÂ§ma. Ãƒâ€“nce docs/chatgpt_status/_shared/status/codex_single_runner_panel_repair_result_20260706.json ve docs/chatgpt_status/_shared/reports/SINGLE_RUNNER_PANEL_AND_NEW_PAGE_FLOW_FINAL_20260706.md dosyalarÃ„Â±nÃ„Â± oku. Sonra kendi page_key kuyruÃ„Å¸unu docs/chatgpt_status/<PAGE_KEY>/queue altÃ„Â±na allowed_paths ve safe flags ile yaz. final_ready=false kalsÃ„Â±n; gerÃƒÂ§ek GitHub kanÃ„Â±tÃ„Â± olmadan completed, yÃƒÂ¼zde 100 veya final_ready=true yazma. KullanÃ„Â±cÃ„Â± sadece "devam et" derse aynÃ„Â± shared runner status/panel kanÃ„Â±tlarÃ„Â±nÃ„Â± kontrol et ve gerÃƒÂ§ek blocker varsa blocker olarak raporla.
## Common Prompt Update

The previously missing branch prompt paths have been restored. Use docs/chatgpt_status/_shared/prompts/AAYS_CHATGPT_COMMON_DEVAM_PROMPT_20260706.md as the shared prompt for every ChatGPT page. Page-specific blockers remain evidence-based and must be handled only inside the owning page_key. Main integration, DB write, migration, production deploy, fake completed, fake heartbeat, fake 100 percent, fake final_ready=true, and new parallel runners are explicitly skipped in this continuation flow.
