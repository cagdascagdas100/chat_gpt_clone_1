...
$scanRunner = Join-Path $automationRoot "RUN_SINGLE_AAYS_MULTI_PAGE_QUEUE_RUNNER_V5_20260706.ps1"
...
$state = [ordered]@{
  ...
  scan_runner = "RUN_SINGLE_AAYS_MULTI_PAGE_QUEUE_RUNNER_V5_20260706"
