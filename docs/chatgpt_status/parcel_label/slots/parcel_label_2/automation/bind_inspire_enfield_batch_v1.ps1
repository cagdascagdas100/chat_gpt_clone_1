...
$pythonScript = Join-Path $repoRoot 'docs\chatgpt_status\parcel_label\slots\parcel_label_2\automation\bind_inspire_enfield_batch_v21.py'
...
Write-Output 'TASK_VERSION=8.0-feature-member-cardinality-and-collection-count-batch'
