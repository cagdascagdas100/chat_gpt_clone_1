...
$pythonScript = Join-Path $repoRoot 'docs\chatgpt_status\parcel_label\slots\parcel_label_2\automation\bind_inspire_enfield_batch_v14.py'
...
Write-Output 'TASK_VERSION=7.3-streaming-canonical-and-download-batch'
