...
$pythonScript = Join-Path $repoRoot 'docs\chatgpt_status\parcel_label\slots\parcel_label_2\automation\bind_inspire_enfield_batch_v3.py'
...
Write-Output 'TASK_VERSION=6.2-official-gml-or-zip-strict-payload-batch'
