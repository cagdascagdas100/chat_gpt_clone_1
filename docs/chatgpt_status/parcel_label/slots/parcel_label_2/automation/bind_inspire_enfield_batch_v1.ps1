...
$pythonScript = Join-Path $repoRoot 'docs\chatgpt_status\parcel_label\slots\parcel_label_2\automation\bind_inspire_enfield_batch_v33.py'
...
Write-Output 'TASK_VERSION=9.2-descriptor-pinned-parser-source-batch'
