...
$pythonScript = Join-Path $repoRoot 'docs\chatgpt_status\parcel_label\slots\parcel_label_2\automation\bind_inspire_enfield_batch_v27.py'
...
Write-Output 'TASK_VERSION=8.6-lxml-comment-and-processing-instruction-normalisation-batch'
