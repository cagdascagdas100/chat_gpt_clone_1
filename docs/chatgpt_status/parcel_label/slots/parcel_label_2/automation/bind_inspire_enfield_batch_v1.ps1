...
$pythonScript = Join-Path $repoRoot 'docs\chatgpt_status\parcel_label\slots\parcel_label_2\automation\bind_inspire_enfield_batch_v26.py'
...
Write-Output 'TASK_VERSION=8.5-secure-lxml-libxml2-backend-fallback-batch'
