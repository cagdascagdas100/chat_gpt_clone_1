...
$pythonScript = Join-Path $repoRoot 'docs\chatgpt_status\parcel_label\slots\parcel_label_2\automation\bind_inspire_enfield_batch_v34.py'
...
Write-Output 'TASK_VERSION=9.3-immutable-private-snapshot-parser-source-batch'
