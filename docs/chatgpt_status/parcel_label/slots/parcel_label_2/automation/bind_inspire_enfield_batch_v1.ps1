...
$pythonScript = Join-Path $repoRoot 'docs\chatgpt_status\parcel_label\slots\parcel_label_2\automation\bind_inspire_enfield_batch_v25.py'
...
Write-Output 'TASK_VERSION=8.4-expat-2.7.2-security-floor-batch'
