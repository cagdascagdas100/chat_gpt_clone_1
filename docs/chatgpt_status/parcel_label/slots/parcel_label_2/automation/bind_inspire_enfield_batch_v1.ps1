...
$pythonScript = Join-Path $repoRoot 'docs\chatgpt_status\parcel_label\slots\parcel_label_2\automation\bind_inspire_enfield_batch_v20.py'
...
Write-Output 'TASK_VERSION=7.9-feature-collection-membership-and-container-scope-batch'
