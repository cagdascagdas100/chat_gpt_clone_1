...
$pythonScript = Join-Path $repoRoot 'docs\chatgpt_status\parcel_label\slots\parcel_label_2\automation\bind_inspire_enfield_batch_v31.py'
...
Write-Output 'TASK_VERSION=9.0-lxml-cumulative-expanded-element-name-bounds-batch'
