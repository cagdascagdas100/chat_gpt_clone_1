...
$pythonScript = Join-Path $repoRoot 'docs\chatgpt_status\parcel_label\slots\parcel_label_2\automation\bind_inspire_enfield_batch_v4.py'
...
Write-Output 'TASK_VERSION=6.3-bounded-dns-preflight-official-gml-batch'
