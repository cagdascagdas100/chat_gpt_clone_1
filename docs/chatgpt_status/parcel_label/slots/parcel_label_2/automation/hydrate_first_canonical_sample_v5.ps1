...
$pythonScript = Join-Path $repoRoot 'docs\chatgpt_status\parcel_label\slots\parcel_label_2\automation\hydrate_first_canonical_sample_v5.py'
if (-not (Test-Path -LiteralPath $pythonScript -PathType Leaf)) {
  throw "PARCEL_LABEL_2_V5_PYTHON_SCRIPT_MISSING: $pythonScript"
}
...
Write-Output 'ATTEMPT_ID=parcel-label-2-20260721-010'
