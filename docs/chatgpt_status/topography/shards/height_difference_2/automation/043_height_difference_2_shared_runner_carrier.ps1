...
$taskVersion = '6.6-preweb-height-metric-gate'
$pickupRequestRevision = 16
...
$expectedEntryBlob = '54e301461379b1f0688d7fc651ce633420fca258'
$expectedNumericGateBlob = '5bab5fda5a25dbc67dd1aa219aae961b8acf1368'
$expectedMetricGuardBlob = 'f9b70ef7adc1d2d3673501e0b82a992d230efc2f'
...
$expectedWebVerifierBlob = '84a560369b1c589aa1b74965f3c8c2ebc91e3caf'
$expectedEaCoverageId = '13787b9a-26a4-4775-8523-806d13af58fc__Lidar_Composite_Elevation_DTM_1m'
...
$numericGateRel = 'docs\chatgpt_status\topography\shards\height_difference_2\automation\014_run_official_numeric_gate.py'
$metricGuardRel = 'docs\chatgpt_status\topography\shards\height_difference_2\automation\018_verify_current_height_difference_metric.py'
...
$webVerifierRel = 'docs\chatgpt_status\topography\shards\height_difference_2\automation\017_verify_height_difference_2_web_8012.py'
...
$numericGateBlob = Assert-GitBlob $repoRoot $numericGateRel $expectedNumericGateBlob 'HEIGHT_DIFFERENCE_2_NUMERIC_GATE'
$metricGuardBlob = Assert-GitBlob $repoRoot $metricGuardRel $expectedMetricGuardBlob 'HEIGHT_DIFFERENCE_2_HEIGHT_METRIC_GUARD'
...
$webVerifierBlob = Assert-GitBlob $repoRoot $webVerifierRel $expectedWebVerifierBlob 'HEIGHT_DIFFERENCE_2_WEB_VERIFIER'
...
$env:AAYS_EA_DTM1M_COVERAGE_ID = $expectedEaCoverageId
...
Write-Output "NUMERIC_GATE_BLOB_SHA=$numericGateBlob"
Write-Output "HEIGHT_METRIC_GUARD_BLOB_SHA=$metricGuardBlob"
...
Write-Output "WEB_VERIFIER_BLOB_SHA=$webVerifierBlob"
Write-Output "RECONCILED_ENTRYPOINT_BLOB_SHA=$entryBlob"
Write-Output "EA_DTM1M_COVERAGE_ID=$expectedEaCoverageId"
...
Write-Output 'CURRENT_HEIGHT_DIFFERENCE_METRIC_GUARD_REQUIRED=true'
Write-Output 'CURRENT_HEIGHT_DIFFERENCE_METRIC_MUST_PASS_BEFORE_TERRAIN50_AND_WEB=true'
Write-Output 'CURRENT_HEIGHT_DIFFERENCE_TOLERANCE_M=0.001'
Write-Output 'CURRENT_CANDIDATE_HEIGHT_DIFFERENCE_FIELD=height_difference_m'
Write-Output 'CURRENT_CANDIDATE_MEDIAN_ELEVATION_IS_DISTINCT=true'
Write-Output 'CURRENT_CANDIDATE_EXACT_METRIC_BINDING_REQUIRED=true'
...
Write-Output 'PORT_8012_LOOPBACK_ONLY=true'
Write-Output 'PORT_8012_CURRENT_CANDIDATE_LOCAL_SHA256_REQUIRED=true'
Write-Output 'PORT_8012_CURRENT_CANDIDATE_METRIC_BINDING_REQUIRED=true'
Write-Output 'PORT_8012_HTTP_CANDIDATE_SHA256_REQUIRED=false'
Write-Output 'PORT_8012_BASE_AUTOPROBE_REQUIRED=true'
Write-Output 'PORT_8012_OPERATION_FILE_PATH_GUARD_REQUIRED=true'
Write-Output 'PORT_8012_SOURCE_FILE_PATH_AND_COUNT_GUARD_REQUIRED=true'
Write-Output 'PORT_8012_EXAMPLE_FILE_PATH_AND_COUNT_GUARD_REQUIRED=true'
Write-Output 'PORT_8012_EXACT_HMLR_MEASUREMENT_CONFIDENCE_BINDING_REQUIRED=true'
