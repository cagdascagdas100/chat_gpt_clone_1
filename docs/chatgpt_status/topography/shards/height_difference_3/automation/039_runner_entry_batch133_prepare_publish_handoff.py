#!/usr/bin/env python3
"""Same-task strict12 entrypoint with control-plane and publish-manifest byte seals."""
...
def main()->int:
    ...
    acc_path=repo/"docs/chatgpt_status/topography/shards/height_difference_3/runner_outputs/029_batch131_strict12_acceptance/batch131_strict12_local_acceptance.json"; acc=load(acc_path); acceptance_sha=sha(acc_path)
    ...
    m=load(manifest); manifest_sha=sha(manifest)
