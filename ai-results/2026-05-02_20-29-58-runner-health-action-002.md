...
## Task
Runner action mode health check after local patch

## Task ID
runner-health-action-002
...
## Output
powershell : Cannot process the command because of a missing parameter. A command must follow -Command.
At C:\Users\cagda\Documents\chat_gpt_clone_1\chatgpt-github-runner.ps1:138 char:23
+ ...        $output = powershell -NoProfile -Command $command 2>&1 | Out-S ...
+                      ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
EXAMPLES
    ...
    PowerShell -version 3.0 -NoLogo -InputFormat text -OutputFormat XML
