...
## Output
```text
powershell.exe : Join-Path : Cannot bind argument to parameter 'Path' because it is null.
...
+                 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    + CategoryInfo          : NotSpecified: (Join-Path : Can...use it is null.:String) [], RemoteException
