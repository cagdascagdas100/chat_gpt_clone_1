...
$Audit = [ordered]@{
  task_id = "ty-pdi-017-clean-bridge-selftest"
  status = "completed"
...
$Audit | ConvertTo-Json -Depth 8 | Set-Content -Path (Join-Path $ResultsDir "ty-pdi-017-clean-bridge-selftest.audit.json") -Encoding UTF8
