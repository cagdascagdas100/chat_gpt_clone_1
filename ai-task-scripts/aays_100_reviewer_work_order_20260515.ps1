...
$Report = Join-Path $ResultDir "aays-100-reviewer-work-order-$Stamp.md"
$Heartbeat = Join-Path $HeartbeatDir 'reviewer-work-order.md'
$Lines = @(
...
Write-Output 'AAYS_100_REVIEWER_WORK_ORDER_DONE=true'
