...
OUT = Path(".github/tmp_bt9_batch143_willington_20260813.py")

text = subprocess.check_output(["git", "show", f"{TEMPLATE_COMMIT}:{TEMPLATE_PATH}"], text=True)
replacements = [
    ('CITY = "Ripon"', 'CITY = "Willington"'),
    ('GRID = "RIPON_CENTRAL_02"', 'GRID = "WILLINGTON_COUNTY_DURHAM_01"'),
    ('LOCAL_AUTHORITY = "North Yorkshire"', 'LOCAL_AUTHORITY = "County Durham"'),
    ('BATCH = 46', 'BATCH = 143'),
    ('EXPECTED_BEFORE = 2250', 'EXPECTED_BEFORE = 7100'),
    ('TARGET_AFTER = 2300', 'TARGET_AFTER = 7150'),
    ('NEXT_TARGET = 2350', 'NEXT_TARGET = 7200'),
    ('xs = [-1.5650, -1.5350, -1.5050, -1.4750]', 'xs = [-1.7400, -1.7150, -1.6900, -1.6650, -1.6400]'),
    ('ys = [54.1100, 54.1320, 54.1540, 54.1760]', 'ys = [54.6800, 54.6950, 54.7100, 54.7250, 54.7400]'),
    ('(+evidence batch 46)', '(+evidence batch 143)'),
    ('OpenStreetMap API 0.6 - Ripon batch 46', 'OpenStreetMap API 0.6 - Willington batch 143'),
    ('appended 50 Ripon OSM API records', 'appended 50 Willington OSM API records'),
    ('Batch 46 appended 50 new Ripon OSM API evidence-backed building features', 'Batch 143 appended 50 new Willington OSM API evidence-backed building features'),
    ('BATCH_046_APPENDED_50_RIPON_OSM_FEATURES_CONTINUATION_REQUIRED', 'BATCH_143_APPENDED_50_WILLINGTON_OSM_FEATURES_CONTINUATION_REQUIRED'),
    ('APPEND_NEW_BATCH_047_AFTER_FEATURE_2300', 'APPEND_NEW_BATCH_144_AFTER_FEATURE_7150'),
