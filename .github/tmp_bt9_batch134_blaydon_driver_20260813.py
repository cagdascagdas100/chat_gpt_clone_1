...
OUT = Path(".github/tmp_bt9_batch134_blaydon_20260813.py")

text = subprocess.check_output(["git", "show", f"{TEMPLATE_COMMIT}:{TEMPLATE_PATH}"], text=True)
replacements = [
    ('CITY = "Ripon"', 'CITY = "Blaydon"'),
    ('GRID = "RIPON_CENTRAL_02"', 'GRID = "BLAYDON_GATESHEAD_01"'),
    ('LOCAL_AUTHORITY = "North Yorkshire"', 'LOCAL_AUTHORITY = "Gateshead"'),
    ('BATCH = 46', 'BATCH = 134'),
    ('EXPECTED_BEFORE = 2250', 'EXPECTED_BEFORE = 6650'),
    ('TARGET_AFTER = 2300', 'TARGET_AFTER = 6700'),
    ('NEXT_TARGET = 2350', 'NEXT_TARGET = 6750'),
    ('xs = [-1.5650, -1.5350, -1.5050, -1.4750]', 'xs = [-1.7650, -1.7400, -1.7150, -1.6900, -1.6650]'),
    ('ys = [54.1100, 54.1320, 54.1540, 54.1760]', 'ys = [54.9350, 54.9500, 54.9650, 54.9800, 54.9950]'),
    ('(+evidence batch 46)', '(+evidence batch 134)'),
    ('OpenStreetMap API 0.6 - Ripon batch 46', 'OpenStreetMap API 0.6 - Blaydon batch 134'),
    ('appended 50 Ripon OSM API records', 'appended 50 Blaydon OSM API records'),
    ('Batch 46 appended 50 new Ripon OSM API evidence-backed building features', 'Batch 134 appended 50 new Blaydon OSM API evidence-backed building features'),
    ('BATCH_046_APPENDED_50_RIPON_OSM_FEATURES_CONTINUATION_REQUIRED', 'BATCH_134_APPENDED_50_BLAYDON_OSM_FEATURES_CONTINUATION_REQUIRED'),
    ('APPEND_NEW_BATCH_047_AFTER_FEATURE_2300', 'APPEND_NEW_BATCH_135_AFTER_FEATURE_6700'),
