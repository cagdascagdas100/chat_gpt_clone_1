...
OUT = Path(".github/tmp_bt9_batch141_trimdon_20260813.py")

text = subprocess.check_output(["git", "show", f"{TEMPLATE_COMMIT}:{TEMPLATE_PATH}"], text=True)
replacements = [
    ('CITY = "Ripon"', 'CITY = "Trimdon"'),
    ('GRID = "RIPON_CENTRAL_02"', 'GRID = "TRIMDON_COUNTY_DURHAM_01"'),
    ('LOCAL_AUTHORITY = "North Yorkshire"', 'LOCAL_AUTHORITY = "County Durham"'),
    ('BATCH = 46', 'BATCH = 141'),
    ('EXPECTED_BEFORE = 2250', 'EXPECTED_BEFORE = 7000'),
    ('TARGET_AFTER = 2300', 'TARGET_AFTER = 7050'),
    ('NEXT_TARGET = 2350', 'NEXT_TARGET = 7100'),
    ('xs = [-1.5650, -1.5350, -1.5050, -1.4750]', 'xs = [-1.4800, -1.4550, -1.4300, -1.4050, -1.3800]'),
    ('ys = [54.1100, 54.1320, 54.1540, 54.1760]', 'ys = [54.6700, 54.6850, 54.7000, 54.7150, 54.7300]'),
    ('(+evidence batch 46)', '(+evidence batch 141)'),
    ('OpenStreetMap API 0.6 - Ripon batch 46', 'OpenStreetMap API 0.6 - Trimdon batch 141'),
    ('appended 50 Ripon OSM API records', 'appended 50 Trimdon OSM API records'),
    ('Batch 46 appended 50 new Ripon OSM API evidence-backed building features', 'Batch 141 appended 50 new Trimdon OSM API evidence-backed building features'),
    ('BATCH_046_APPENDED_50_RIPON_OSM_FEATURES_CONTINUATION_REQUIRED', 'BATCH_141_APPENDED_50_TRIMDON_OSM_FEATURES_CONTINUATION_REQUIRED'),
    ('APPEND_NEW_BATCH_047_AFTER_FEATURE_2300', 'APPEND_NEW_BATCH_142_AFTER_FEATURE_7050'),
