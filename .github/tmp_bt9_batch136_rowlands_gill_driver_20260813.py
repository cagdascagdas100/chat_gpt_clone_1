...
OUT = Path(".github/tmp_bt9_batch136_rowlands_gill_20260813.py")

text = subprocess.check_output(["git", "show", f"{TEMPLATE_COMMIT}:{TEMPLATE_PATH}"], text=True)
replacements = [
    ('CITY = "Ripon"', 'CITY = "Rowlands Gill"'),
    ('GRID = "RIPON_CENTRAL_02"', 'GRID = "ROWLANDS_GILL_GATESHEAD_01"'),
    ('LOCAL_AUTHORITY = "North Yorkshire"', 'LOCAL_AUTHORITY = "Gateshead"'),
    ('BATCH = 46', 'BATCH = 136'),
    ('EXPECTED_BEFORE = 2250', 'EXPECTED_BEFORE = 6750'),
    ('TARGET_AFTER = 2300', 'TARGET_AFTER = 6800'),
    ('NEXT_TARGET = 2350', 'NEXT_TARGET = 6850'),
    ('xs = [-1.5650, -1.5350, -1.5050, -1.4750]', 'xs = [-1.8050, -1.7800, -1.7550, -1.7300, -1.7050]'),
    ('ys = [54.1100, 54.1320, 54.1540, 54.1760]', 'ys = [54.8800, 54.8950, 54.9100, 54.9250, 54.9400]'),
    ('(+evidence batch 46)', '(+evidence batch 136)'),
    ('OpenStreetMap API 0.6 - Ripon batch 46', 'OpenStreetMap API 0.6 - Rowlands Gill batch 136'),
    ('appended 50 Ripon OSM API records', 'appended 50 Rowlands Gill OSM API records'),
    ('Batch 46 appended 50 new Ripon OSM API evidence-backed building features', 'Batch 136 appended 50 new Rowlands Gill OSM API evidence-backed building features'),
    ('BATCH_046_APPENDED_50_RIPON_OSM_FEATURES_CONTINUATION_REQUIRED', 'BATCH_136_APPENDED_50_ROWLANDS_GILL_OSM_FEATURES_CONTINUATION_REQUIRED'),
    ('APPEND_NEW_BATCH_047_AFTER_FEATURE_2300', 'APPEND_NEW_BATCH_137_AFTER_FEATURE_6800'),
