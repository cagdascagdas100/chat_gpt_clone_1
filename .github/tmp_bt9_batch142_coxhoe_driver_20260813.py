...
OUT = Path(".github/tmp_bt9_batch142_coxhoe_20260813.py")

text = subprocess.check_output(["git", "show", f"{TEMPLATE_COMMIT}:{TEMPLATE_PATH}"], text=True)
replacements = [
    ('CITY = "Ripon"', 'CITY = "Coxhoe"'),
    ('GRID = "RIPON_CENTRAL_02"', 'GRID = "COXHOE_COUNTY_DURHAM_01"'),
    ('LOCAL_AUTHORITY = "North Yorkshire"', 'LOCAL_AUTHORITY = "County Durham"'),
    ('BATCH = 46', 'BATCH = 142'),
    ('EXPECTED_BEFORE = 2250', 'EXPECTED_BEFORE = 7050'),
    ('TARGET_AFTER = 2300', 'TARGET_AFTER = 7100'),
    ('NEXT_TARGET = 2350', 'NEXT_TARGET = 7150'),
    ('xs = [-1.5650, -1.5350, -1.5050, -1.4750]', 'xs = [-1.5800, -1.5550, -1.5300, -1.5050, -1.4800]'),
    ('ys = [54.1100, 54.1320, 54.1540, 54.1760]', 'ys = [54.6900, 54.7050, 54.7200, 54.7350, 54.7500]'),
    ('(+evidence batch 46)', '(+evidence batch 142)'),
    ('OpenStreetMap API 0.6 - Ripon batch 46', 'OpenStreetMap API 0.6 - Coxhoe batch 142'),
    ('appended 50 Ripon OSM API records', 'appended 50 Coxhoe OSM API records'),
    ('Batch 46 appended 50 new Ripon OSM API evidence-backed building features', 'Batch 142 appended 50 new Coxhoe OSM API evidence-backed building features'),
    ('BATCH_046_APPENDED_50_RIPON_OSM_FEATURES_CONTINUATION_REQUIRED', 'BATCH_142_APPENDED_50_COXHOE_OSM_FEATURES_CONTINUATION_REQUIRED'),
    ('APPEND_NEW_BATCH_047_AFTER_FEATURE_2300', 'APPEND_NEW_BATCH_143_AFTER_FEATURE_7100'),
