...
OUT = Path(".github/tmp_bt9_batch140_murton_20260813.py")

text = subprocess.check_output(["git", "show", f"{TEMPLATE_COMMIT}:{TEMPLATE_PATH}"], text=True)
replacements = [
    ('CITY = "Ripon"', 'CITY = "Murton"'),
    ('GRID = "RIPON_CENTRAL_02"', 'GRID = "MURTON_COUNTY_DURHAM_01"'),
    ('LOCAL_AUTHORITY = "North Yorkshire"', 'LOCAL_AUTHORITY = "County Durham"'),
    ('BATCH = 46', 'BATCH = 140'),
    ('EXPECTED_BEFORE = 2250', 'EXPECTED_BEFORE = 6950'),
    ('TARGET_AFTER = 2300', 'TARGET_AFTER = 7000'),
    ('NEXT_TARGET = 2350', 'NEXT_TARGET = 7050'),
    ('xs = [-1.5650, -1.5350, -1.5050, -1.4750]', 'xs = [-1.4550, -1.4300, -1.4050, -1.3800, -1.3550]'),
    ('ys = [54.1100, 54.1320, 54.1540, 54.1760]', 'ys = [54.7950, 54.8100, 54.8250, 54.8400, 54.8550]'),
    ('(+evidence batch 46)', '(+evidence batch 140)'),
    ('OpenStreetMap API 0.6 - Ripon batch 46', 'OpenStreetMap API 0.6 - Murton batch 140'),
    ('appended 50 Ripon OSM API records', 'appended 50 Murton OSM API records'),
    ('Batch 46 appended 50 new Ripon OSM API evidence-backed building features', 'Batch 140 appended 50 new Murton OSM API evidence-backed building features'),
    ('BATCH_046_APPENDED_50_RIPON_OSM_FEATURES_CONTINUATION_REQUIRED', 'BATCH_140_APPENDED_50_MURTON_OSM_FEATURES_CONTINUATION_REQUIRED'),
    ('APPEND_NEW_BATCH_047_AFTER_FEATURE_2300', 'APPEND_NEW_BATCH_141_AFTER_FEATURE_7000'),
