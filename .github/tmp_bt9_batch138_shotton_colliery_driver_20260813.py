...
OUT = Path(".github/tmp_bt9_batch138_shotton_colliery_20260813.py")

text = subprocess.check_output(["git", "show", f"{TEMPLATE_COMMIT}:{TEMPLATE_PATH}"], text=True)
replacements = [
    ('CITY = "Ripon"', 'CITY = "Shotton Colliery"'),
    ('GRID = "RIPON_CENTRAL_02"', 'GRID = "SHOTTON_COLLIERY_COUNTY_DURHAM_01"'),
    ('LOCAL_AUTHORITY = "North Yorkshire"', 'LOCAL_AUTHORITY = "County Durham"'),
    ('BATCH = 46', 'BATCH = 138'),
    ('EXPECTED_BEFORE = 2250', 'EXPECTED_BEFORE = 6850'),
    ('TARGET_AFTER = 2300', 'TARGET_AFTER = 6900'),
    ('NEXT_TARGET = 2350', 'NEXT_TARGET = 6950'),
    ('xs = [-1.5650, -1.5350, -1.5050, -1.4750]', 'xs = [-1.4350, -1.4100, -1.3850, -1.3600, -1.3350]'),
    ('ys = [54.1100, 54.1320, 54.1540, 54.1760]', 'ys = [54.7350, 54.7500, 54.7650, 54.7800, 54.7950]'),
    ('(+evidence batch 46)', '(+evidence batch 138)'),
    ('OpenStreetMap API 0.6 - Ripon batch 46', 'OpenStreetMap API 0.6 - Shotton Colliery batch 138'),
    ('appended 50 Ripon OSM API records', 'appended 50 Shotton Colliery OSM API records'),
    ('Batch 46 appended 50 new Ripon OSM API evidence-backed building features', 'Batch 138 appended 50 new Shotton Colliery OSM API evidence-backed building features'),
    ('BATCH_046_APPENDED_50_RIPON_OSM_FEATURES_CONTINUATION_REQUIRED', 'BATCH_138_APPENDED_50_SHOTTON_COLLIERY_OSM_FEATURES_CONTINUATION_REQUIRED'),
    ('APPEND_NEW_BATCH_047_AFTER_FEATURE_2300', 'APPEND_NEW_BATCH_139_AFTER_FEATURE_6900'),
