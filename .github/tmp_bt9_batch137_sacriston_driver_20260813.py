...
OUT = Path(".github/tmp_bt9_batch137_sacriston_20260813.py")

text = subprocess.check_output(["git", "show", f"{TEMPLATE_COMMIT}:{TEMPLATE_PATH}"], text=True)
replacements = [
    ('CITY = "Ripon"', 'CITY = "Sacriston"'),
    ('GRID = "RIPON_CENTRAL_02"', 'GRID = "SACRISTON_COUNTY_DURHAM_01"'),
    ('LOCAL_AUTHORITY = "North Yorkshire"', 'LOCAL_AUTHORITY = "County Durham"'),
    ('BATCH = 46', 'BATCH = 137'),
    ('EXPECTED_BEFORE = 2250', 'EXPECTED_BEFORE = 6800'),
    ('TARGET_AFTER = 2300', 'TARGET_AFTER = 6850'),
    ('NEXT_TARGET = 2350', 'NEXT_TARGET = 6900'),
    ('xs = [-1.5650, -1.5350, -1.5050, -1.4750]', 'xs = [-1.6800, -1.6550, -1.6300, -1.6050, -1.5800]'),
    ('ys = [54.1100, 54.1320, 54.1540, 54.1760]', 'ys = [54.7900, 54.8050, 54.8200, 54.8350, 54.8500]'),
    ('(+evidence batch 46)', '(+evidence batch 137)'),
    ('OpenStreetMap API 0.6 - Ripon batch 46', 'OpenStreetMap API 0.6 - Sacriston batch 137'),
    ('appended 50 Ripon OSM API records', 'appended 50 Sacriston OSM API records'),
    ('Batch 46 appended 50 new Ripon OSM API evidence-backed building features', 'Batch 137 appended 50 new Sacriston OSM API evidence-backed building features'),
    ('BATCH_046_APPENDED_50_RIPON_OSM_FEATURES_CONTINUATION_REQUIRED', 'BATCH_137_APPENDED_50_SACRISTON_OSM_FEATURES_CONTINUATION_REQUIRED'),
    ('APPEND_NEW_BATCH_047_AFTER_FEATURE_2300', 'APPEND_NEW_BATCH_138_AFTER_FEATURE_6850'),
