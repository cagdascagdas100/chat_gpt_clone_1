...
OUT = Path(".github/tmp_bt9_batch135_ryton_20260813.py")

text = subprocess.check_output(["git", "show", f"{TEMPLATE_COMMIT}:{TEMPLATE_PATH}"], text=True)
replacements = [
    ('CITY = "Ripon"', 'CITY = "Ryton"'),
    ('GRID = "RIPON_CENTRAL_02"', 'GRID = "RYTON_GATESHEAD_01"'),
    ('LOCAL_AUTHORITY = "North Yorkshire"', 'LOCAL_AUTHORITY = "Gateshead"'),
    ('BATCH = 46', 'BATCH = 135'),
    ('EXPECTED_BEFORE = 2250', 'EXPECTED_BEFORE = 6700'),
    ('TARGET_AFTER = 2300', 'TARGET_AFTER = 6750'),
    ('NEXT_TARGET = 2350', 'NEXT_TARGET = 6800'),
    ('xs = [-1.5650, -1.5350, -1.5050, -1.4750]', 'xs = [-1.8250, -1.8000, -1.7750, -1.7500, -1.7250]'),
    ('ys = [54.1100, 54.1320, 54.1540, 54.1760]', 'ys = [54.9450, 54.9600, 54.9750, 54.9900, 55.0050]'),
    ('(+evidence batch 46)', '(+evidence batch 135)'),
    ('OpenStreetMap API 0.6 - Ripon batch 46', 'OpenStreetMap API 0.6 - Ryton batch 135'),
    ('appended 50 Ripon OSM API records', 'appended 50 Ryton OSM API records'),
    ('Batch 46 appended 50 new Ripon OSM API evidence-backed building features', 'Batch 135 appended 50 new Ryton OSM API evidence-backed building features'),
    ('BATCH_046_APPENDED_50_RIPON_OSM_FEATURES_CONTINUATION_REQUIRED', 'BATCH_135_APPENDED_50_RYTON_OSM_FEATURES_CONTINUATION_REQUIRED'),
    ('APPEND_NEW_BATCH_047_AFTER_FEATURE_2300', 'APPEND_NEW_BATCH_136_AFTER_FEATURE_6750'),
