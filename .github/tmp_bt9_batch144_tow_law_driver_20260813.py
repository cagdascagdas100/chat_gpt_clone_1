...
OUT = Path(".github/tmp_bt9_batch144_tow_law_20260813.py")

text = subprocess.check_output(["git", "show", f"{TEMPLATE_COMMIT}:{TEMPLATE_PATH}"], text=True)
replacements = [
    ('CITY = "Ripon"', 'CITY = "Tow Law"'),
    ('GRID = "RIPON_CENTRAL_02"', 'GRID = "TOW_LAW_COUNTY_DURHAM_01"'),
    ('LOCAL_AUTHORITY = "North Yorkshire"', 'LOCAL_AUTHORITY = "County Durham"'),
    ('BATCH = 46', 'BATCH = 144'),
    ('EXPECTED_BEFORE = 2250', 'EXPECTED_BEFORE = 7150'),
    ('TARGET_AFTER = 2300', 'TARGET_AFTER = 7200'),
    ('NEXT_TARGET = 2350', 'NEXT_TARGET = 7250'),
    ('xs = [-1.5650, -1.5350, -1.5050, -1.4750]', 'xs = [-1.8650, -1.8400, -1.8150, -1.7900, -1.7650]'),
    ('ys = [54.1100, 54.1320, 54.1540, 54.1760]', 'ys = [54.7350, 54.7500, 54.7650, 54.7800, 54.7950]'),
    ('(+evidence batch 46)', '(+evidence batch 144)'),
    ('OpenStreetMap API 0.6 - Ripon batch 46', 'OpenStreetMap API 0.6 - Tow Law batch 144'),
    ('appended 50 Ripon OSM API records', 'appended 50 Tow Law OSM API records'),
    ('Batch 46 appended 50 new Ripon OSM API evidence-backed building features', 'Batch 144 appended 50 new Tow Law OSM API evidence-backed building features'),
    ('BATCH_046_APPENDED_50_RIPON_OSM_FEATURES_CONTINUATION_REQUIRED', 'BATCH_144_APPENDED_50_TOW_LAW_OSM_FEATURES_CONTINUATION_REQUIRED'),
    ('APPEND_NEW_BATCH_047_AFTER_FEATURE_2300', 'APPEND_NEW_BATCH_145_AFTER_FEATURE_7200'),
