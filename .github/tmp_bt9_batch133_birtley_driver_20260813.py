...
OUT = Path(".github/tmp_bt9_batch133_birtley_20260813.py")

text = subprocess.check_output(["git", "show", f"{TEMPLATE_COMMIT}:{TEMPLATE_PATH}"], text=True)
replacements = [
    ('CITY = "Ripon"', 'CITY = "Birtley"'),
    ('GRID = "RIPON_CENTRAL_02"', 'GRID = "BIRTLEY_GATESHEAD_01"'),
    ('LOCAL_AUTHORITY = "North Yorkshire"', 'LOCAL_AUTHORITY = "Gateshead"'),
    ('BATCH = 46', 'BATCH = 133'),
    ('EXPECTED_BEFORE = 2250', 'EXPECTED_BEFORE = 6600'),
    ('TARGET_AFTER = 2300', 'TARGET_AFTER = 6650'),
    ('NEXT_TARGET = 2350', 'NEXT_TARGET = 6700'),
    ('xs = [-1.5650, -1.5350, -1.5050, -1.4750]', 'xs = [-1.6250, -1.6000, -1.5750, -1.5500, -1.5250]'),
    ('ys = [54.1100, 54.1320, 54.1540, 54.1760]', 'ys = [54.8650, 54.8800, 54.8950, 54.9100, 54.9250]'),
    ('(+evidence batch 46)', '(+evidence batch 133)'),
    ('OpenStreetMap API 0.6 - Ripon batch 46', 'OpenStreetMap API 0.6 - Birtley batch 133'),
    ('appended 50 Ripon OSM API records', 'appended 50 Birtley OSM API records'),
    ('Batch 46 appended 50 new Ripon OSM API evidence-backed building features', 'Batch 133 appended 50 new Birtley OSM API evidence-backed building features'),
    ('BATCH_046_APPENDED_50_RIPON_OSM_FEATURES_CONTINUATION_REQUIRED', 'BATCH_133_APPENDED_50_BIRTLEY_OSM_FEATURES_CONTINUATION_REQUIRED'),
    ('APPEND_NEW_BATCH_047_AFTER_FEATURE_2300', 'APPEND_NEW_BATCH_134_AFTER_FEATURE_6650'),
