...
def test_classify_sale_land_record_includes_source_confidence_metadata() -> None:
    ...
    assert result["source_confidence"]["source_confidence_needs_review"] is True
    assert result["source_confidence"]["source_confidence_review_route"] == "source_confidence_review"
